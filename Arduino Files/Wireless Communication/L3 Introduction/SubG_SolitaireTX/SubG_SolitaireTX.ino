...
void setup() {
  ...
  ELECHOUSE_cc1101.setMHZ(922);            // Here you can set your basic frequency. The lib calculates the frequency automatically (default = 433.92).The cc1101 can: 300-348 MHZ, 387-464MHZ and 779-928MHZ. Read More info from datasheet.
...
*/
  ...
  if(digitalRead(32)) {
    ELECHOUSE_cc1101.SendData("I am Ian", 100);
    digitalWrite(2, 1);
    //delay(1000);
    digitalWrite(2, 0);
    count++; 
